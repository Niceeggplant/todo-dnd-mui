...
interface Props {
  ...
  completedTodos: Todo[];
  undoTodos: Todo[];
  setUndos: React.Dispatch<React.SetStateAction<Todo[]>>;
...
export const TodoList: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    return () => { console.log(completedTodos,todos) };
  }, []);
  ...
  return (
    ...
    <div className="container">
      ...
      <div className='none'>
        <Droppable droppableId="TodosFuture">
          {(provided, snapshot) => (
            <div
        ...
        <Droppable droppableId="TodosunDo" >
          {(provided, snapshot) => (
            <div
              className={`todos undo ${snapshot.isDraggingOver ? "dragcomplete" : ""
                }`}
              ref={provided.innerRef}
              {...provided.droppableProps}
            >
